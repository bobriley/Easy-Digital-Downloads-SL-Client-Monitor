...
<div class="wrap">
    ...
    <h2><?php SC_EDD_SL_CM_U::_e('Tools'); ?></h2>
    <?php
    ...
    <div id="sc-edd-sl-cm-options" class="inside">
        <h2 class="nav-tab-wrapper">  
            <a href="?page=<?php echo SC_EDD_SL_CM_Constants::PLUGIN_SLUG . '&tab=main' ?>" class="nav-tab <?php echo $active_tab == 'main' ? 'nav-tab-active' : ''; ?>"><?php SC_EDD_SL_CM_U::_e('Main'); ?></a>  
        </h2>
        <form id="easy-pie-cs-main-form" method="post" action="<?php echo admin_url('admin.php?page=' . SC_EDD_SL_CM_Constants::$TOOLS_SUBMENU_SLUG . '&tab=' . $active_tab); ?>" > 
            <?php
            //  settings_fields(SC_EDD_SL_CM_Constants::MAIN_PAGE_KEY);
            //do_settings_sections(SC_EDD_SL_CM_Constants::MAIN_PAGE_KEY);                        
...
<!--            <input type="hidden" id="sc-edd-sl-cm-submit-type" name="sc-edd-sl-cm-submit-type" value="save"/>
           ...
           <input type="submit" name="submit" id="submit" class="button button-primary" value="Save Changes" />
            ...
            <a href="https://snapcreek.com/ezp-coming-soon/docs/faqs-tech/" target="_blank"><?php SC_EDD_SL_CM_U::_e('FAQ'); ?></a>
            |           
            <a href="https://snapcreek.com/support/" target="_blank"><?php SC_EDD_SL_CM_U::_e('Contact') ?></a>
        </form>
    </div>
</div>
